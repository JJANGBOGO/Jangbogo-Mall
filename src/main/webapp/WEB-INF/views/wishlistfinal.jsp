...
<script>
    ...
    $(document).ready(function (){
        ...
        $(".insert-btn").click(function(){
            let prod_idx = $('.hidden_input').text(); // 상품번호
    ...
    let listToHtml = function (wishlists){
        ...
        wishlists.forEach(function (product){
            ...
            tmp += '</div>'
            tmp += '<div class="e">'
            tmp += '<button class="delBtn" type="button" width="104" height="36" radius="4">삭제</button>'
            tmp += '<button class="openBtn" type="button" width="104" height="36" radius="4">담기</button>'
            tmp += '</div>'
            tmp += '</div>'
            tmp += '</div>'
